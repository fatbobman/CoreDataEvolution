...
- 支持 `@Inverse(TargetEntity.self, "property")` 显式 inverse hint
...
2. 文档参数与语义对齐（去除 `relationshipGetterPolicy`）。  
   Test: `rg "relationshipGetterPolicy" Docs/Development/Specification.md Docs/Development/DesignNotes.md Docs/Development/ImplementationPlan.md`
