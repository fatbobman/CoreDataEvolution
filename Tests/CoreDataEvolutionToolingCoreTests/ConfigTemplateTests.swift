...
struct ConfigTemplateTests {
  ...
  func minimalPresetKeepsOnlyRequiredFields() throws {
    ...
    #expect(template.generate?.relationshipRules == nil)
    #expect(template.generate?.compositionRules == nil)
    #expect(template.generate?.generateToManyCount == nil)
    ...
    #expect(template.validate?.relationshipRules == nil)
    #expect(template.validate?.compositionRules == nil)
    #expect(template.validate?.generateToManyCount == nil)
  ...
  func fullPresetIncludesDocumentedDefaults() throws {
    ...
    #expect(template.generate?.relationshipRules == .init())
    #expect(template.generate?.compositionRules == .init())
    ...
    #expect(template.generate?.generateToManyCount == true)
    ...
    #expect(template.validate?.relationshipRules == .init())
    #expect(template.validate?.compositionRules == .init())
    #expect(template.validate?.momcBin == nil)
    #expect(template.validate?.generateToManyCount == true)
