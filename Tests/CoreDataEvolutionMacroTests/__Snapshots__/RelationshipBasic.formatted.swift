...
final class Item: NSManagedObject {
  ...
  private static let __cd_relationship_validate_tag_entity: Void = CoreDataEvolution
  ...
  private static let __cd_relationship_validate_orderedCategories_entity: Void = CoreDataEvolution
