...
struct MacroExpansionSnapshotTests {
  ...
  @Test("PersistentModel relationship persistent name snapshot")
  func persistentModelRelationshipPersistentNameSnapshot() throws {
    try MacroTestSupport.assertExpansionSnapshot(
